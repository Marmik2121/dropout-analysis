...
$orders=$obj->query("select * from class9");
				...
				<div class="container-fluid p-0">
					...
					<div class="card flex-fill">
						<div class="card-header">
							...
							<h5 class="card-title mb-0">All Students Of 9th STD</h5>
						</div>
						<table id="datatables-dashboard-products" class="table table-striped my-0">
							...
							<tbody>
								...
								while($result = $orders->fetch_object())
								{
									?>
									<tr>
										<td><?php echo "$result->s9id";?></td>
										<td><?php echo "$result->s9name";?></td>
										<td><?php echo "$result->s9age";?></td>
										<td><?php echo "$result->s9gender";?></td>
										<td><?php echo "$result->s9caste"?></td>
										<td><?php echo "$result->s9dob";?></td>
										<td><?php echo "$result->s9year";?></td>
									</tr>
									<?php
								}
								?>

...
$orders=$obj->query("select * from class10");
...
<head>
	...
	<title>Detail Of Class-10</title>
				...
				<div class="container-fluid p-0">
					...
					<div class="card flex-fill">
						<div class="card-header">
							...
							<h5 class="card-title mb-0">All Students Of 10th STD</h5>
						</div>
						<table id="datatables-dashboard-products" class="table table-striped my-0">
							<thead>
								<tr>
									...
									<th class="d-none d-xl-table-cell">Caste</th>
									<th class="d-none d-xl-table-cell">Date of Birth</th>
									<th class="d-none d-xl-table-cell">Study Year</th>
								</tr>
							</thead>
							<tbody>
								<?php
								while($result = $orders->fetch_object())
								{
									?>
									<tr>
										<td><?php echo "$result->s10id";?></td>
										<td><?php echo "$result->s10name";?></td>
										<td><?php echo "$result->s10age";?></td>
										<td><?php echo "$result->s10gender";?></td>
										<td><?php echo "$result->s10caste"?></td>
										<td><?php echo "$result->s10dob";?></td>
										<td><?php echo "$result->s10year";?></td>
									</tr>
									<?php
								}
								?>
